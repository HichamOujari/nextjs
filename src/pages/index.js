	...
	return (
		<Fragment>
			...
			<SectionUpdate>
				...
				<SectionUpdate.Text>
					On July 1, the College announced plans for a partial return to campus for the Fall 2020 term. We recently posted reopening guidelines, policies, procedures and protocols that will be in place beginning in the Fall term. Current campus access protocols remain in place until the Fall term begins. See the pages linked below and in the left hand column for details. Please contact ehsxx with questions regarding safety and/or the guidelines and protocols established by the College for the Fall term.
				</SectionUpdate.Text>
			...
			<SectionResources linkHref="/" linkLabel="View more resources">
				<SectionResources.Item
					...
					time="4:24PM"
				>
					Google Drive is a cloud storage solution with 15GB of storage available for free and paid plans with additional storage and features. Google Drive is a… user-friendly option thanks to its simple interface and integration with Google Docs.
				</SectionResources.Item>
				<SectionResources.Item
				...
				<SectionResources.Item
					...
					time="4:24PM"
				>
					Times being what they are, you may have found that you’re suddenly leading a remote team, and now you’re wondering how to lead from afar. Or you’re concerned that suddenly splitting your team physically will result in a fractured, less-efficient team.
				</SectionResources.Item>
			</SectionResources>
		</Fragment>
	);
